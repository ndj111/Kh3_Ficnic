...
<div class="page-cont">
	...
	<div>
		${List[0].getBoard_id()} &nbsp; >${List[0].getBoard_id()}<br>
	</div>
		...
		<c:forEach items="${List}" var="dto">
			<tr>
                ...
                <div class="col-6 mt-3">
                    <form name="search_form" method="get" action="<%=request.getContextPath()%>/site/board/board_list.do?bbs_id=${List[0].getBoard_id()}">
	...
	<div class="col-6 text-right mt-3">
             ...
             <c:when test="${!empty field}">
             	<a href="<%=request.getContextPath()%>/site/board/board_list.do" class="btn btn-outline-secondary"><i class="fa fa-list mr-1"></i> 게시물 전체목록</a>
             </c:when>
             <c:otherwise>
             	<a href="<%=request.getContextPath()%>/site/board/board_write.do" class="btn btn-primary"><i class="fa fa-pencil mr-1"></i> 새로운 글쓰기</a>
             </c:otherwise>
             </c:choose>
	</div>		
